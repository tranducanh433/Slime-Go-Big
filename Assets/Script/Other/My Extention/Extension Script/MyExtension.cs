...
namespace MyExtension
{
    ...
    public static class MyExtension
    {
        ...
        /// <summary>
        /// Get child index depend on parent of this object
        /// </summary>
        /// <param name="transform"></param>
        /// <returns></returns>
        public static int ToChildIndex(this Transform transform)
        {
        ...
        public static Vector2 ToDirection2D(this float angle)
        {
        ...
        public static float SetLimit(this float value, float min, float max)
        {
            if (value < min)
                return min;
            if (value > max)
