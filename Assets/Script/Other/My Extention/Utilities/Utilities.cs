...
namespace GreenSlime.Calculator
{
    ...
    public static class VectorValue
    {
        ...
        public static Vector2 GetRandomDirection(float startAngle, float endAngle)
        {
            float randAngle = Random.Range(startAngle, endAngle);
            return randAngle.ToDirection2D();
        }
    }
